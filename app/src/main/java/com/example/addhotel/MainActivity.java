...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    private void UploadImage() {
        if (imagePath != null) {
            ...
            final StorageReference ref = storage.getReference().child("IMAGE_FILES" + System.currentTimeMillis() + "." + getFileExtension(imagePath));
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            String imageurl, hotelname, hoteladdress;
                            float count = ratingBar.getRating();
                            hotelname = editText.getText().toString();
                            hoteladdress = address.getText().toString();
                            imageurl = uri.toString();
                            DisplayDetail displayDetail = new DisplayDetail(hotelname, imageurl, hoteladdress, count);
                            DatabaseReference reference = database.getReference().child("Hotels");
                            String id=reference.push().getKey();
                            reference.child("HotelDetail").child(id).setValue(displayDetail);
